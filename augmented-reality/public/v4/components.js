      ...
      const createObjects = ({detail}) => {
        if (!found) {
          ...
          setTimeout(() => {
            ...
            floatingTurtle2.setAttribute('gltf-model', require('./assets/models/punkin-red.glb'))
            ...
            floatingTurtle3.setAttribute('gltf-model', require('./assets/models/punkin-pink.glb'))
